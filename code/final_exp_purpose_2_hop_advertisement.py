...
from config import advertisement_2_hop_settings as purpose_settings

# Seeds
seeds = purpose_settings.seeds
...
# Filepaths
filepaths = purpose_settings.filepaths
dataset = filepaths.dataset
model_path = filepaths.model_path

# Labels
labels = purpose_settings.labels

# Dataset Config
dataset_config = purpose_settings.dataset
...
model_config = purpose_settings.model
...
# Experiment Config
training_config = purpose_settings.training
...
experiment = BinaryclassExperiment(name='Purpose_Advertisement_2_Hop',
                                   model=model,
