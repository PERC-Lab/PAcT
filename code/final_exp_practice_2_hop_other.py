"""Script to test the config class"""
...
from code_flow.model_zoo import AttentionModel
from config import practice_other_2_hop_settings as practice_settings
...
experiment = BinaryclassExperiment(name='Practice_Other_2_Hop',
                                   model=model,
                                   ...
                                   dirpath='2-layer-decoder/practice')
